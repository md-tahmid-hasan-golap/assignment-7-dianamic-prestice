      ...
      <div className="main-container flex justify-center mt-30">
        ...
        <div className="right-container w-[30%]">
          <div className="flex justify-center items-center">
            ...
            <h1 className="mt-2 text-2xl font-bold text-blue-500 ">
              {" "}
              Favourites
            </h1>
          </div>
          ...
          <ToastContainer />
          {bookmarked.length == 0 ? (
            <h1 className=" mt-10 w-64 h-40 p-4 border border-gray-300 rounded-lg shadow-md bg-white justify-center items-center font-bold text-3xl">
              No Cart Avaiable Select a card
            </h1>
          ) : (
            bookmarked.map((mark) => (
              <div
                key={mark.id}
                className=" ml-10 flex mt-10 w-64 h-[250px] p-4 border border-gray-300 rounded-lg shadow-md bg-white"
              >
                <div>
                ...
                <div>
                  ...
                  <button
                    onClick={() => removeBlog(mark)}
                    className=" ml-5 bg-white-500 text-black px-2 border border-gray-300 rounded-lg"
                  >
                    x
                  </button>
                </div>
